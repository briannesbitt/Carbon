...
```php
$now = Carbon::now();
echo $now;                               // 2014-06-25 07:46:09
$today = Carbon::today();
echo $today;                             // 2014-06-25 00:00:00
$tomorrow = Carbon::tomorrow('Europe/London');
echo $tomorrow;                          // 2014-06-26 00:00:00
$yesterday = Carbon::yesterday();
echo $yesterday;                         // 2014-06-24 00:00:00
```
...
echo Carbon::now();                                    // 2014-06-25 07:46:09
```
...
echo $dt1->max();                                  // 2014-06-25 07:46:09
```
