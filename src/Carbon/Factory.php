 ...
 * @method void                setTranslator(\Symfony\Contracts\Translation\TranslatorInterface $translator)                                                      Set the default translator instance to use.
 ...
 * @method string              translateTimeString(string $timeString, $from = null, $to = null, $mode = CarbonInterface::TRANSLATE_ALL)                          Translate a time string from a locale to an other.
 * @method string              translateWith(\Symfony\Contracts\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null) Translate using translation string or callback available.
