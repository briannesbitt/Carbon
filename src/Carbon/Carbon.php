 ...
 * @method        $this            addYears(int|float $value = 1, ?int $anchorDay = null)                             Add years (the $value count passed in) to the instance (using date interval).
 * @method        $this            addYear(?int $anchorDay = null)                                                    Add one year to the instance (using date interval).
 ...
 * @method        $this            subYear(?int $anchorDay = null)                                                    Sub one year to the instance (using date interval).
 ...
 * @method        $this            addYearWithOverflow(?int $anchorDay = null)                                        Add one year to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subYearWithOverflow(?int $anchorDay = null)                                        Sub one year to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addYearWithoutOverflow(?int $anchorDay = null)                                     Add one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearsWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)              Sub years (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearWithoutOverflow(?int $anchorDay = null)                                     Sub one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addYearsWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Add years (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addYearWithNoOverflow(?int $anchorDay = null)                                      Add one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearsWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Sub years (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearWithNoOverflow(?int $anchorDay = null)                                      Sub one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addYearsNoOverflow(int|float $value = 1, ?int $anchorDay = null)                   Add years (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addYearNoOverflow(?int $anchorDay = null)                                          Add one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearsNoOverflow(int|float $value = 1, ?int $anchorDay = null)                   Sub years (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subYearNoOverflow(?int $anchorDay = null)                                          Sub one year to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMonths(int|float $value = 1, ?int $anchorDay = null)                            Add months (the $value count passed in) to the instance (using date interval).
 * @method        $this            addMonth(?int $anchorDay = null)                                                   Add one month to the instance (using date interval).
 ...
 * @method        $this            subMonth(?int $anchorDay = null)                                                   Sub one month to the instance (using date interval).
 ...
 * @method        $this            addMonthWithOverflow(?int $anchorDay = null)                                       Add one month to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subMonthWithOverflow(?int $anchorDay = null)                                       Sub one month to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addMonthWithoutOverflow(?int $anchorDay = null)                                    Add one month to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthsWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)             Sub months (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthWithoutOverflow(?int $anchorDay = null)                                    Sub one month to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMonthsWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)              Add months (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMonthWithNoOverflow(?int $anchorDay = null)                                     Add one month to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthsWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)              Sub months (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthWithNoOverflow(?int $anchorDay = null)                                     Sub one month to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMonthsNoOverflow(int|float $value = 1, ?int $anchorDay = null)                  Add months (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMonthNoOverflow(?int $anchorDay = null)                                         Add one month to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthsNoOverflow(int|float $value = 1, ?int $anchorDay = null)                  Sub months (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMonthNoOverflow(?int $anchorDay = null)                                         Sub one month to the instance (using date interval) with overflow explicitly forbidden.
 ...
 * @method        $this            addMillennia(int|float $value = 1, ?int $anchorDay = null)                         Add millennia (the $value count passed in) to the instance (using date interval).
 * @method        $this            addMillennium(?int $anchorDay = null)                                              Add one millennium to the instance (using date interval).
 ...
 * @method        $this            subMillennium(?int $anchorDay = null)                                              Sub one millennium to the instance (using date interval).
 ...
 * @method        $this            addMillenniumWithOverflow(?int $anchorDay = null)                                  Add one millennium to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subMillenniumWithOverflow(?int $anchorDay = null)                                  Sub one millennium to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addMillenniumWithoutOverflow(?int $anchorDay = null)                               Add one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniaWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)          Sub millennia (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniumWithoutOverflow(?int $anchorDay = null)                               Sub one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMillenniaWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)           Add millennia (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMillenniumWithNoOverflow(?int $anchorDay = null)                                Add one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniaWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)           Sub millennia (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniumWithNoOverflow(?int $anchorDay = null)                                Sub one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMillenniaNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Add millennia (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addMillenniumNoOverflow(?int $anchorDay = null)                                    Add one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniaNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Sub millennia (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subMillenniumNoOverflow(?int $anchorDay = null)                                    Sub one millennium to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addCenturies(int|float $value = 1, ?int $anchorDay = null)                         Add centuries (the $value count passed in) to the instance (using date interval).
 * @method        $this            addCentury(?int $anchorDay = null)                                                 Add one century to the instance (using date interval).
 ...
 * @method        $this            subCentury(?int $anchorDay = null)                                                 Sub one century to the instance (using date interval).
 ...
 * @method        $this            addCenturyWithOverflow(?int $anchorDay = null)                                     Add one century to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subCenturyWithOverflow(?int $anchorDay = null)                                     Sub one century to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addCenturyWithoutOverflow(?int $anchorDay = null)                                  Add one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturiesWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)          Sub centuries (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturyWithoutOverflow(?int $anchorDay = null)                                  Sub one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addCenturiesWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)           Add centuries (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addCenturyWithNoOverflow(?int $anchorDay = null)                                   Add one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturiesWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)           Sub centuries (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturyWithNoOverflow(?int $anchorDay = null)                                   Sub one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addCenturiesNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Add centuries (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addCenturyNoOverflow(?int $anchorDay = null)                                       Add one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturiesNoOverflow(int|float $value = 1, ?int $anchorDay = null)               Sub centuries (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subCenturyNoOverflow(?int $anchorDay = null)                                       Sub one century to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addDecades(int|float $value = 1, ?int $anchorDay = null)                           Add decades (the $value count passed in) to the instance (using date interval).
 * @method        $this            addDecade(?int $anchorDay = null)                                                  Add one decade to the instance (using date interval).
 ...
 * @method        $this            subDecade(?int $anchorDay = null)                                                  Sub one decade to the instance (using date interval).
 ...
 * @method        $this            addDecadeWithOverflow(?int $anchorDay = null)                                      Add one decade to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subDecadeWithOverflow(?int $anchorDay = null)                                      Sub one decade to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addDecadeWithoutOverflow(?int $anchorDay = null)                                   Add one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadesWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)            Sub decades (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadeWithoutOverflow(?int $anchorDay = null)                                   Sub one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addDecadesWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)             Add decades (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addDecadeWithNoOverflow(?int $anchorDay = null)                                    Add one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadesWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)             Sub decades (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadeWithNoOverflow(?int $anchorDay = null)                                    Sub one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addDecadesNoOverflow(int|float $value = 1, ?int $anchorDay = null)                 Add decades (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addDecadeNoOverflow(?int $anchorDay = null)                                        Add one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadesNoOverflow(int|float $value = 1, ?int $anchorDay = null)                 Sub decades (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subDecadeNoOverflow(?int $anchorDay = null)                                        Sub one decade to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addQuarters(int|float $value = 1, ?int $anchorDay = null)                          Add quarters (the $value count passed in) to the instance (using date interval).
 * @method        $this            addQuarter(?int $anchorDay = null)                                                 Add one quarter to the instance (using date interval).
 ...
 * @method        $this            subQuarter(?int $anchorDay = null)                                                 Sub one quarter to the instance (using date interval).
 ...
 * @method        $this            addQuarterWithOverflow(?int $anchorDay = null)                                     Add one quarter to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            subQuarterWithOverflow(?int $anchorDay = null)                                     Sub one quarter to the instance (using date interval) with overflow explicitly allowed.
 ...
 * @method        $this            addQuarterWithoutOverflow(?int $anchorDay = null)                                  Add one quarter to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuartersWithoutOverflow(int|float $value = 1, ?int $anchorDay = null)           Sub quarters (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuarterWithoutOverflow(?int $anchorDay = null)                                  Sub one quarter to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addQuartersWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)            Add quarters (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addQuarterWithNoOverflow(?int $anchorDay = null)                                   Add one quarter to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuartersWithNoOverflow(int|float $value = 1, ?int $anchorDay = null)            Sub quarters (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuarterWithNoOverflow(?int $anchorDay = null)                                   Sub one quarter to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addQuartersNoOverflow(int|float $value = 1, ?int $anchorDay = null)                Add quarters (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            addQuarterNoOverflow(?int $anchorDay = null)                                       Add one quarter to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuartersNoOverflow(int|float $value = 1, ?int $anchorDay = null)                Sub quarters (the $value count passed in) to the instance (using date interval) with overflow explicitly forbidden.
 * @method        $this            subQuarterNoOverflow(?int $anchorDay = null)                                       Sub one quarter to the instance (using date interval) with overflow explicitly forbidden.
