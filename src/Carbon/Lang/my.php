...
return [
    'year' => ':count နှစ်',
    'a_year' => '{1}တစ်နှစ်|]1,Inf[:count နှစ်',
    'y' => ':count နှစ်',
    'month' => ':count လ',
    'a_month' => '{1}တစ်လ|]1,Inf[:count လ',
    'm' => ':count လ',
    'week' => ':count ပတ်',
    'w' => ':count ပတ်',
    'day' => ':count ရက်',
    'a_day' => '{1}တစ်ရက်|]1,Inf[:count ရက်',
    'd' => ':count ရက်',
    'hour' => ':count နာရီ',
    'a_hour' => '{1}တစ်နာရီ|]1,Inf[:count နာရီ',
    'h' => ':count နာရီ',
    'minute' => ':count မိနစ်',
    'a_minute' => '{1}တစ်မိနစ်|]1,Inf[:count မိနစ်',
    'min' => ':count မိနစ်',
    'second' => ':count စက္ကန့်',
    'a_second' => '{0,1}စက္ကန်.အနည်းငယ်|]1,Inf[:count စက္ကန့်',
    's' => ':count စက္ကန့်',
