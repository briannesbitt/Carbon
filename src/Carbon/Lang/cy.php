 ...
 */
return [
    'year' => '{1}:count flwyddyn|]1,Inf[:count flynedd',
    'a_year' => '{1}blwyddyn|]1,Inf[:count flynedd',
    'y' => ':countbl',
    'month' => ':count mis',
    'a_month' => '{1}mis|]1,Inf[:count mis',
    'm' => ':countmi',
    'week' => ':count wythnos',
    'a_week' => '{1}wythnos|]1,Inf[:count wythnos',
    'w' => ':countw',
    'day' => ':count diwrnod',
    'a_day' => '{1}diwrnod|]1,Inf[:count diwrnod',
    'd' => ':countd',
    'hour' => ':count awr',
    'a_hour' => '{1}awr|]1,Inf[:count awr',
    'h' => ':counth',
    'minute' => ':count munud',
    'a_minute' => '{1}munud|]1,Inf[:count munud',
    'min' => ':countm',
    'second' => ':count eiliad',
    'a_second' => '{0,1}ychydig eiliadau|]1,Inf[:count eiliad',
    's' => ':counts',
    'ago' => ':time yn ôl',
    'from_now' => 'mewn :time',
    'after' => ':time ar ôl',
