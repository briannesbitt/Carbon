...
return [
    ...
    's' => ':count s',
    'millisecond' => '{1}:count milliseconde|{0}:count millisecondes|]1,Inf[:count millisecondes',
    'a_millisecond' => '{1}quelques millisecondes|{0}:count millisecondes|]1,Inf[:count millisecondes',
    'ms' => ':countms',
    'ago' => 'il y a :time',
    'from_now' => 'dans :time',
    'after' => ':time après',
