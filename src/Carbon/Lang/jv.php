...
return [
    'year' => ':count taun',
    'a_year' => '{1}setaun|]1,Inf[:count taun',
    'month' => ':count wulan',
    'a_month' => '{1}sewulan|]1,Inf[:count wulan',
    'week' => ':count minggu',
    'a_week' => '{1}sakminggu|]1,Inf[:count minggu',
    'day' => ':count dina',
    'a_day' => '{1}sedina|]1,Inf[:count dina',
    'hour' => ':count jam',
    'a_hour' => '{1}setunggal jam|]1,Inf[:count jam',
    'minute' => ':count menit',
    'a_minute' => '{1}setunggal menit|]1,Inf[:count menit',
    'second' => ':count detik',
    'a_second' => '{0,1}sawetawis detik|]1,Inf[:count detik',
