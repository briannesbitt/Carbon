...
return [
    ...
    's' => ':counts',
    'millisecond' => '{1}:count milisegundo|{0}:count milisegundos|]1,Inf[:count milisegundos',
    'a_millisecond' => '{1}unos pocos milisegundos|{0}:count milisegundos|]1,Inf[:count milisegundos',
    'ms' => ':countms',
    'ago' => 'hace :time',
    'from_now' => 'en :time',
    'after' => ':time después',
