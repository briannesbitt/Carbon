...
return [
    'year' => ':count ឆ្នាំ',
    'a_year' => '{1}មួយឆ្នាំ|]1,Inf[:count ឆ្នាំ',
    'y' => ':count ឆ្នាំ',
    'month' => ':count ខែ',
    'a_month' => '{1}មួយខែ|]1,Inf[:count ខែ',
    'm' => ':count ខែ',
    'week' => ':count សប្តាហ៍',
    'w' => ':count សប្តាហ៍',
    'day' => ':count ថ្ងៃ',
    'a_day' => '{1}មួយថ្ងៃ|]1,Inf[:count ថ្ងៃ',
    'd' => ':count ថ្ងៃ',
    'hour' => ':count ម៉ោង',
    'a_hour' => '{1}មួយម៉ោង|]1,Inf[:count ម៉ោង',
    'h' => ':count ម៉ោង',
    'minute' => ':count នាទី',
    'a_minute' => '{1}មួយនាទី|]1,Inf[:count នាទី',
    'min' => ':count នាទី',
    'second' => ':count វិនាទី',
    'a_second' => '{0,1}ប៉ុន្មានវិនាទី|]1,Inf[:count វិនាទី',
    's' => ':count វិនាទី',
    'ago' => ':timeមុន',
    'from_now' => ':timeទៀត',
    'after' => 'នៅ​ក្រោយ :time',
