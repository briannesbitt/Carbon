...
return [
    ...
    'y' => ':count tahun',
    'month' => '{1}:count bulan|]1,Inf[:count bulan',
    'a_month' => '{1}sebulan|]1,Inf[:count bulan',
    'm' => ':count bulan',
    'week' => '{1}:count minggu|]1,Inf[:count minggu',
    'a_week' => '{1}seminggu|]1,Inf[:count minggu',
    'w' => ':count minggu',
    'day' => '{1}:count hari|]1,Inf[:count hari',
    'a_day' => '{1}sehari|]1,Inf[:count hari',
    'd' => ':count hari',
    'hour' => '{1}:count jam|]1,Inf[:count jam',
    'a_hour' => '{1}sejam|]1,Inf[:count jam',
    'h' => ':count jam',
    'minute' => '{1}:count minit|]1,Inf[:count minit',
    'a_minute' => '{1}seminit|]1,Inf[:count minit',
    'min' => ':count minit',
    'second' => '{1}:count saat|]1,Inf[:count saat',
    'a_second' => '{1}beberapa saat|]1,Inf[:count saat',
    'millisecond' => '{1}:count milisaat|]1,Inf[:count milisaat',
    'a_millisecond' => '{1}semilisaat|]1,Inf[:count milliseconds',
    'microsecond' => '{1}:count mikrodetik|]1,Inf[:count mikrodetik',
