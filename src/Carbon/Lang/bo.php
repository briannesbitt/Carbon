...
return [
    'year' => 'ལོ:count',
    'a_year' => '{1}ལོ་གཅིག|]1,Inf[ལོ:count',
    'month' => 'ཟླ་བ:count',
    'a_month' => '{1}ཟླ་བ་གཅིག|]1,Inf[ཟླ་བ:count',
    'week' => 'གཟའ་འཁོར་:count',
    'a_week' => 'གཟའ་འཁོར་གཅིག',
    'day' => 'ཉིན:count་',
    'a_day' => '{1}ཉིན་གཅིག|]1,Inf[ཉིན:count',
    'hour' => 'ཆུ་ཚོད:count',
    'a_hour' => '{1}ཆུ་ཚོད་གཅིག|]1,Inf[ཆུ་ཚོད:count',
    'minute' => 'སྐར་མ་:count',
    'a_minute' => '{1}སྐར་མ་གཅིག|]1,Inf[སྐར་མ་:count',
    'second' => 'སྐར་ཆ:count',
    'a_second' => '{0,1}ལམ་སང|]1,Inf[སྐར་ཆ:count',
    'ago' => ':time སྔན་ལ',
    'from_now' => ':time ལ་',
    'diff_yesterday' => 'ཁ་སང',
    'diff_today' => 'དི་རིང',
