...
trait Date
{
    ...
    {
        return FactoryImmutable::getDefaultInstance()->getWeekendDays();
    }
     ...
     */
    public static function hasRelativeKeywords($time): bool
    {
    ...
    {
        foreach ((FactoryImmutable::getDefaultInstance()->getSettings()['genericMacros'] ?? []) as $list) {
