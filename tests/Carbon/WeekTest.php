...
{
    public function dataProviderTestWeekUtils(): Generator
    {
        yield ['1990-12-20', [
            1990,
            1990,
     ...
     * @dataProvider dataProviderTestWeekUtils
     */
    public function testWeekUtils($date, $expected)
    {
        [$weekYear, $isoWeekYear, $week, $isoWeek, $weeksInYear, $isoWeeksInYear] = $expected;
