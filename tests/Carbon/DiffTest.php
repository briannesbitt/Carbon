...
class DiffTest extends AbstractTestCase
{
    ...
    public function testFloatDiff()
    {
        ...
        $this->assertSame(1, Carbon::parse('2018-02-13 20:55:12.321456')->diffInYears(Carbon::parse('2019-02-13 20:55:12.321456')));
        ...
        $this->assertSame(1, Carbon::parse('2018-10-01 00:00:00', 'Europe/Paris')->diffInMonths(Carbon::parse('2018-11-01 00:00:00', 'Europe/Paris')));
        $this->assertSame(1, Carbon::parse('2018-10-28 00:00:00')->diffInMonths(Carbon::parse('2018-11-28 00:00:00')));
        $this->assertSame(1, Carbon::parse('2018-10-28 00:00:00', 'Europe/Paris')->diffInMonths(Carbon::parse('2018-11-28 00:00:00', 'Europe/Paris')));

        $this->assertSame(-1, Carbon::parse('2018-11-01 00:00:00', 'Europe/Paris')->diffInMonths(Carbon::parse('2018-10-01 00:00:00', 'Europe/Paris'), false));
        $this->assertSame(-1, Carbon::parse('2018-11-28 00:00:00')->diffInMonths(Carbon::parse('2018-10-28 00:00:00'), false));
        $this->assertSame(-1, Carbon::parse('2018-11-28 00:00:00', 'Europe/Paris')->diffInMonths(Carbon::parse('2018-10-28 00:00:00', 'Europe/Paris'), false));
    }
