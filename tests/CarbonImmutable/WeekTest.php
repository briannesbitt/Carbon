...
{
    public function dataProviderWeekTest(): Generator
    {
        yield ['1990-12-20', [
            1990,
            1990,
    ...
    /**
     * @dataProvider dataProviderWeekTest
     *
     * @param string $date
     * @param array  $values
     */
    public function testWeekUtils($date, $values)
    {
        [$weekYear, $isoWeekYear, $week, $isoWeek, $weeksInYear, $isoWeeksInYear] = $values;
