...
class MyCarbonImmutable extends CarbonImmutable
{
}
...
class StringsTest extends TestFixture
{
    ...
    {
        $d = CarbonImmutable::create(1975, 12, 25, 14, 15, 16, 'Europe/London');
    ...
    {
        $d = CarbonImmutable::create(2000, 5, 2, 4, 3, 4);
