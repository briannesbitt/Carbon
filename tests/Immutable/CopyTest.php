...
class CopyTest extends TestFixture
{
    ...
    {
        $dating  = CarbonImmutable::createFromDate(2000, 1, 1, 'Europe/London');
        $dating2 = $dating->copy();
    ...
    {
        $micro   = 254687;
        $dating  = CarbonImmutable::createFromFormat('Y-m-d H:i:s.u', '2014-02-01 03:45:27.' . $micro);
        $dating2 = $dating->copy();
