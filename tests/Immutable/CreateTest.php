...
class CreateTest extends TestFixture
{
    ...
    {
        $d = CarbonImmutable::create();
        $this->assertSame($d->timestamp, CarbonImmutable::now()->timestamp);
    }

    public function testCreateWithYear()
    {
        $d = CarbonImmutable::create(2012);
    ...
    public function testCreateWithInvalidYear()
    {
        ...
        $d = CarbonImmutable::create(-3);
    }

    public function testCreateWithMonth()
    {
        $d = CarbonImmutable::create(null, 3);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = CarbonImmutable::create(null, -5);
    }
    ...
    {
        $d = CarbonImmutable::create(null, null, 21);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = CarbonImmutable::create(null, null, -4);
    }
    ...
    {
        $d = CarbonImmutable::create(null, null, null, 14);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = CarbonImmutable::create(null, null, null, -1);
    }
    ...
    {
        $d = CarbonImmutable::create(null, null, null, null, 58);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = CarbonImmutable::create(2011, 1, 1, 0, -2, 0);
    }
    ...
    {
        $d = CarbonImmutable::create(null, null, null, null, null, 59);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = CarbonImmutable::create(null, null, null, null, null, -2);
    }
