...
$translations = [
    ...
    ['Carbon::parse("january")', '->monthName'],
    ['Carbon::parse("january")', '->shortMonthName'],
    ['Carbon::parse("february")', '->monthName'],
    ['Carbon::parse("february")', '->shortMonthName'],
    ['Carbon::parse("march")', '->monthName'],
    ['Carbon::parse("march")', '->shortMonthName'],
    ['Carbon::parse("april")', '->monthName'],
    ['Carbon::parse("april")', '->shortMonthName'],
    ['Carbon::parse("may")', '->monthName'],
    ['Carbon::parse("may")', '->shortMonthName'],
    ['Carbon::parse("june")', '->monthName'],
    ['Carbon::parse("june")', '->shortMonthName'],
    ['Carbon::parse("july")', '->monthName'],
    ['Carbon::parse("july")', '->shortMonthName'],
    ['Carbon::parse("august")', '->monthName'],
    ['Carbon::parse("august")', '->shortMonthName'],
    ['Carbon::parse("september")', '->monthName'],
    ['Carbon::parse("september")', '->shortMonthName'],
    ['Carbon::parse("october")', '->monthName'],
    ['Carbon::parse("october")', '->shortMonthName'],
    ['Carbon::parse("november")', '->monthName'],
    ['Carbon::parse("november")', '->shortMonthName'],
    ['Carbon::parse("december")', '->monthName'],
    ['Carbon::parse("december")', '->shortMonthName'],
