...
use function Carbon\Doc\Sponsors\getCustomSponsorOverride;
use function Carbon\Doc\Sponsors\getOpenCollective;
...
function isHistoryUpToDate(): bool
{
    ...
    $versions = json_decode(file_get_contents('https://packagist.org/packages/nesbot/carbon.json'), true)['package']['versions'];
    $maxVersion = '1.0.0';
