...
Why are you not using [composer](http://getcomposer.org/)? Download [Carbon.php](https://raw.github.com/briannesbitt/Carbon/master/src/Carbon/Carbon.php) from the repo and save the file into your project path somewhere.
