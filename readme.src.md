> **This file is autogenerated.  Do not hand modify this file! Please see the [Contributing](#about-contributing) section from more information.**
...
```php
    {{::lint($carbon = new Carbon();/*pad(60)*/)}} // equivalent to Carbon::now()
    {{::lint($carbon = new Carbon('first day of January 2008', 'America/Vancouver');)}}
    {{ctorType::exec(echo get_class($carbon);/*pad(60)*/)}} // '{{ctorType_eval}}'
```
...
{{::lint(
    ...
    {{createFromDateException::exec(try { Carbon::create(1975, 5, 21, 22, 'a', 0); } catch(InvalidArgumentException $x) { printf("%s", $x->getMessage()); })}}
```
...
```php
    {{createFromFormat1::exec(echo Carbon::createFromFormat('Y-m-d H', '1975-05-21 22')->toDateTimeString();/*pad(89)*/)}} // {{createFromFormat1_eval}}
    {{createFromFormat2::exec(echo Carbon::createFromFormat('Y-m-d', '1975-05-21')->toDateTimeString();/*pad(89)*/)}} // {{createFromFormat2_eval}}
```
...
```php
    {{createFromTimeStamp1::exec(echo Carbon::createFromTimeStamp(-1)->toDateTimeString();/*pad(89)*/)}} // {{createFromTimeStamp1_eval}}
    {{createFromTimeStamp2::exec(echo Carbon::createFromTimeStamp(-1, 'Europe/London')->toDateTimeString();/*pad(89)*/)}} // {{createFromTimeStamp2_eval}}
    {{createFromTimeStampUTC::exec(echo Carbon::createFromTimeStampUTC(-1)->toDateTimeString();/*pad(89)*/)}} // {{createFromTimeStampUTC_eval}}
```
...
```php
    ...
    {{ctorType1::exec(echo get_class($carbon);/*pad(60)*/)}} // '{{ctorType1_eval}}'
    {{ctorType2::exec(echo $carbon->toDateTimeString();/*pad(60)*/)}} // '{{ctorType2_eval}}'
```
...
```php
    ...
    {{getmonth::exec(var_dump($dt->month);/*pad(65)*/)}} // {{getmonth_eval}}
    {{getday::exec(var_dump($dt->day);/*pad(65)*/)}} // {{getday_eval}}
    {{gethour::exec(var_dump($dt->hour);/*pad(65)*/)}} // {{gethour_eval}}
    {{getminute::exec(var_dump($dt->minute);/*pad(65)*/)}} // {{getminute_eval}}
    {{getsecond::exec(var_dump($dt->second);/*pad(65)*/)}} // {{getsecond_eval}}
    {{getdow::exec(var_dump($dt->dayOfWeek);/*pad(65)*/)}} // {{getdow_eval}}
    {{getdoy::exec(var_dump($dt->dayOfYear);/*pad(65)*/)}} // {{getdoy_eval}}
    {{getwoy::exec(var_dump($dt->weekOfYear);/*pad(65)*/)}} // {{getwoy_eval}}
    {{getdnm::exec(var_dump($dt->daysInMonth);/*pad(65)*/)}} // {{getdnm_eval}}
    {{getts::exec(var_dump($dt->timestamp);/*pad(65)*/)}} // {{getts_eval}}
    {{getage::exec(var_dump(Carbon::createFromDate(1975, 5, 21)->age);/*pad(65)*/)}} // {{getage_eval}} calculated vs now in the same tz
    {{getq::exec(var_dump($dt->quarter);/*pad(65)*/)}} // {{getq_eval}}

    // Returns an int of seconds difference from UTC (+/- sign included)
    {{get1::exec(var_dump(Carbon::createFromTimestampUTC(0)->offset);/*pad(65)*/)}} // {{get1_eval}}
    {{get2::exec(var_dump(Carbon::createFromTimestamp(0)->offset);/*pad(65)*/)}} // {{get2_eval}}

    // Returns an int of hours difference from UTC (+/- sign included)
    {{get3::exec(var_dump(Carbon::createFromTimestamp(0)->offsetHours);/*pad(65)*/)}} // {{get3_eval}}

    // Indicates if day light savings time is on
    {{get4::exec(var_dump(Carbon::createFromDate(2012, 1, 1)->dst);/*pad(65)*/)}} // {{get4_eval}}

    // Gets the DateTimeZone instance
    {{get5::exec(echo get_class(Carbon::now()->timezone);/*pad(65)*/)}} // {{get5_eval}}
    {{get6::exec(echo get_class(Carbon::now()->tz);/*pad(65)*/)}} // {{get6_eval}}

    // Gets the DateTimeZone instance name, shortcut for ->timezone->getName()
    {{get7::exec(echo Carbon::now()->timezoneName;/*pad(65)*/)}} // {{get7_eval}}
    {{get8::exec(echo Carbon::now()->tzName;/*pad(65)*/)}} // {{get8_eval}}
```
...
```php
    ...
    {{format1::exec(var_dump($dt->toDateTimeString() == $dt);/*pad(65)*/)}} // {{format1_eval}} => uses __toString()
    {{format2::exec(echo $dt->toDateString();/*pad(65)*/)}} // {{format2_eval}}
    {{format3::exec(echo $dt->toFormattedDateString();/*pad(65)*/)}} // {{format3_eval}}
    {{format4::exec(echo $dt->toTimeString();/*pad(65)*/)}} // {{format4_eval}}
    {{format5::exec(echo $dt->toDateTimeString();/*pad(65)*/)}} // {{format5_eval}}
    {{format6::exec(echo $dt->toDayDateTimeString();/*pad(65)*/)}} // {{format6_eval}}

    // ... of course format() is still available
    {{format7::exec(echo $dt->format('l jS \\of F Y h:i:s A');/*pad(65)*/)}}  // {{format7_eval}}
```
...
```php
    ...
    {{compare3::exec(var_dump($first->eq($second));/*pad(65)*/)}} // {{compare3_eval}}
    {{compare4::exec(var_dump($first->ne($second));/*pad(65)*/)}} // {{compare4_eval}}
    {{compare5::exec(var_dump($first->gt($second));/*pad(65)*/)}} // {{compare5_eval}}
    {{compare6::exec(var_dump($first->gte($second));/*pad(65)*/)}} // {{compare6_eval}}
    {{compare7::exec(var_dump($first->lt($second));/*pad(65)*/)}} // {{compare7_eval}}
    ...
    {{compare11::exec(var_dump($first->gt($second));/*pad(65)*/)}} // {{compare11_eval}}
    {{compare12::exec(var_dump($first->gte($second));/*pad(65)*/)}} // {{compare12_eval}}
    {{compare13::exec(var_dump($first->lt($second));/*pad(65)*/)}} // {{compare13_eval}}
    {{compare14::exec(var_dump($first->lte($second));/*pad(65)*/)}} // {{compare14_eval}}
```
...
```php
    ...
    {{diff4::exec(echo $dtOttawa->diffInHours($dtVancouver);/*pad(73)*/)}} // {{diff4_eval}}

    {{diff5::exec(echo $dtOttawa->diffInHours($dtVancouver, false);/*pad(73)*/)}} // {{diff5_eval}}
    {{diff6::exec(echo $dtVancouver->diffInHours($dtOttawa, false);/*pad(73)*/)}} // {{diff6_eval}}

    {{::lint($dt = Carbon::create(2012, 1, 31, 0);)}}
    {{diff8::exec(echo $dt->diffInDays($dt->copy()->addMonth());/*pad(73)*/)}} // {{diff8_eval}}
    {{diff9::exec(echo $dt->diffInDays($dt->copy()->subMonth(), false);/*pad(73)*/)}} // {{diff9_eval}}

    {{::lint($dt = Carbon::create(2012, 4, 30, 0);)}}
    {{diff11::exec(echo $dt->diffInDays($dt->copy()->addMonth());/*pad(73)*/)}} // {{diff11_eval}}
    {{diff12::exec(echo $dt->diffInDays($dt->copy()->addWeek());/*pad(73)*/)}} // {{diff12_eval}}

    {{::lint($dt = Carbon::create(2012, 1, 1, 0);)}}
    {{diff14::exec(echo $dt->diffInMinutes($dt->copy()->addSeconds(59));/*pad(73)*/)}} // {{diff14_eval}}
    {{diff15::exec(echo $dt->diffInMinutes($dt->copy()->addSeconds(60));/*pad(73)*/)}} // {{diff15_eval}}
    {{diff16::exec(echo $dt->diffInMinutes($dt->copy()->addSeconds(119));/*pad(73)*/)}} // {{diff16_eval}}
    {{diff17::exec(echo $dt->diffInMinutes($dt->copy()->addSeconds(120));/*pad(73)*/)}} // {{diff17_eval}}
...
```php
    ...
    {{humandiff1::exec(echo Carbon::now()->subDays(5)->diffForHumans();/*pad(71)*/)}} // {{humandiff1_eval}}

    {{humandiff2::exec(echo Carbon::now()->diffForHumans(Carbon::now()->subYear());/*pad(71)*/)}} // {{humandiff2_eval}}

    {{::lint($dt = Carbon::createFromDate(2011, 2, 1);)}}

    {{humandiff4::exec(echo $dt->diffForHumans($dt->copy()->addMonth());/*pad(71)*/)}} // {{humandiff4_eval}}
    {{humandiff5::exec(echo $dt->diffForHumans($dt->copy()->subMonth());/*pad(71)*/)}} // {{humandiff5_eval}}

    {{humandiff6::exec(echo Carbon::now()->addSeconds(5)->diffForHumans();/*pad(71)*/)}} // {{humandiff6_eval}}
```
